...
// 권한 검사
// config.json 에서 설정
  // 99 : (siteOwner) 사이트 주인, 셋업 가능
  // 9 : (admin) 관리자, 관리자 페이지 접속 가능
  // 8 : (manager) 모든 글 작성 및 타인 글 수정 삭제 가능
  // 4 : (team), 블로그 글 작성 가능, 자기 글 수정 삭제 가능
  // 3 : 인증 유저, 게시판 가능, 블로그 답글 가능, 자기 글 수정삭제 가능.
  // 2 : 인증 유저, 게시판 작성 가능, 자기 글 수정삭제 가능,
